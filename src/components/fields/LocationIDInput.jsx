            ...
            function printChildren(childrenArray,itemArray, depth){
              ...
              childrenArray.map((childItem,i) => {
                if(!childrenArray.length){
                  var child = <Picker.Item label={" ".repeat(5*depth)+childItem.name} value={childItem.id} key={childItem.id}/>;
                  itemArray.push(child);
                }
                else{
                  var parent = <Picker.Item label={" ".repeat(5*depth)+childItem.name} value={childItem.id} key={childItem.id}/>;
                  itemArray.push(parent);
